...
public class HttpRequestBuilder {
    ...
    private HttpRequestBuilder(String type) {
        this.type = type;
    }
    ...
    private HttpRequestBuilder contentType(ContentType contentType) {
    ...
    public <T> T invoke(TypeReference<T> tClass , String charsetName) {
        String invoke = null;
        try {
            invoke = new String(invoke().getBytes(charsetName), StandardCharsets.UTF_8);
